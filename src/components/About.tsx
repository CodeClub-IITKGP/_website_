    ...
    <div className="min-h-screen bg-gray-900 text-white p-4 md:p-6">
      <div className="max-w-4xl mx-auto py-8 md:py-12">
        ...
        <div className="mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4 md:mb-6 text-blue-400">
            Our Mission
          </h2>
        ...
        {/* What We Do */}
        <div className="mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4 md:mb-6 text-purple-400">
            What We Do
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-gray-800 rounded-xl p-4 md:p-6 border border-gray-700 hover:border-blue-500 transition-colors">
              <h3 className="text-lg md:text-xl font-semibold mb-3 text-blue-300">
                🚀 Workshops & Bootcamps
              </h3>
            ...
            <div className="bg-gray-800 rounded-xl p-4 md:p-6 border border-gray-700 hover:border-purple-500 transition-colors">
            ...
            <div className="bg-gray-800 rounded-xl p-4 md:p-6 border border-gray-700 hover:border-green-500 transition-colors">
              <h3 className="text-lg md:text-xl font-semibold mb-3 text-green-300">
            ...
            <div className="bg-gray-800 rounded-xl p-4 md:p-6 border border-gray-700 hover:border-yellow-500 transition-colors">
        ...
        {/* Join Us */}
        <div className="text-center bg-gradient-to-r from-blue-900 to-purple-900 rounded-xl p-6 md:p-8 border border-gray-700">
          ...
          <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 md:px-8 py-2 md:py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-purple-700 transition-all transform hover:scale-105">
            Get Involved
          </button>
        </div>
      </div>
